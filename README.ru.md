...
- **Обнаружение orphan-файлов** — подсветка `.md` и page-constructor `.yaml` файлов, не подключённых к `toc.yaml`, в Explorer; при удалении файлов предлагает удалить из toc или добавить редирект
